...
#                                                 +#+#+#+#+#+   +#+            #
#    Created: 2022/04/11 10:44:45 by lnarvaez          #+#    #+#              #
#    Updated: 2022/04/22 16:41:07 by lnarvaez         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
BONUSSRC	=	ft_lstnew_bonus.c ft_lstadd_front_bonus.c ft_lstsize_bonus.c ft_lstlast_bonus.c \
				ft_lstadd_back_bonus.c ft_lstiter_bonus.c ft_lstdelone_bonus.c \
